...
const projects = [
  ...
  { id: 'enigma-26-hackathon', name: 'enigma26-hackathon', type: 'hackathon project', thumb: 'E26', tone: 'amber', stack: 'Python · Machine learning · Data analysis', description: 'A solution built for the ENIGMA 2026 hackathon, focused on turning a competition brief into a working technical prototype.', details: '<strong>Context:</strong> Built for the ENIGMA 2026 hackathon at IIT BHU.<br><strong>Outcome:</strong> Reached the finalist stage with a practical, working submission.', repo: 'https://github.com/SaswatBalyan/Enigma26-Hackathon' },
  { id: 'heart-disease-playground', name: 'heart-disease-playground', type: 'machine learning pipeline', thumb: 'HD', tone: 'lilac', stack: 'CatBoost · XGBoost · PyTorch · Optuna', description: 'A competition pipeline for predicting heart disease using tuned models, embeddings, ensembling, and cross-validation.', details: '<strong>Modeling:</strong> Combines CatBoost, XGBoost, and PyTorch embeddings with Optuna hyperparameter tuning.<br><strong>Evaluation:</strong> Cross-validation and ensembling improve the reliability of predictions for the Playground Series S6E2 challenge.', repo: 'https://github.com/SaswatBalyan/Predicting-Heart-Disease-Playground-Series-S6ep2' },
  { id: 'churn-rate-playground', name: 'churn-rate-playground', type: 'customer churn prediction', thumb: 'CR', tone: 'mint', stack: 'Python · Machine learning · Classification', description: 'A predictive modeling project for identifying customer churn in the Playground Series S6E3 competition.', details: '<strong>Goal:</strong> Build a classification workflow that estimates which customers are most likely to leave.<br><strong>Focus:</strong> Feature preparation, model training, and validation for the Playground Series S6E3 dataset.', repo: 'https://github.com/SaswatBalyan/Predicting-Churn-Rate-PlaygroundS6e3' },
];
...
function enhanceAboutPage(windowElement) {
  ...
  if (photoGrid) {
    ...
    if (teamCaption) teamCaption.textContent = 'IIC Team 25-26';
